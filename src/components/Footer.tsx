...
export function Footer() {
  return (
    <footer className="border-t border-border bg-card relative mt-20">
      ...
      {/* Bottom Logo */}
      <div className="absolute bottom-20 backdrop-blur-sm rounded-2xl bg-card/60 left-1/2 border-2 border-border hover:border-primary duration-400 flex items-center justify-center p-3 -translate-x-1/2 z-10 drop-shadow-[0_0px_20px_rgba(249,115,22,0.3)]">
        <div className="w-12 h-12 md:w-16 md:h-16 gradient-glow rounded-xl flex items-center justify-center shadow-lg">
          <Box className="w-8 h-8 md:w-10 md:h-10 text-primary-foreground" />
        </div>
      </div>
